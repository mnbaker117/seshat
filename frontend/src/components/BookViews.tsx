...
export function BCard({book,onAction,onClick,showAuthor,highlightAuthorId,showMamLink,onSendToHermeece,selMode,selected,onToggleSel}:BookViewItemProps){const t=useTheme();const isUp=!!book.is_unreleased;const hasCover=book.cover_url||book.cover_path||book.audiobookshelf_id;const isOtherAuthor=highlightAuthorId&&book.author_id&&book.author_id!==highlightAuthorId;
