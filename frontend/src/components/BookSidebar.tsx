...
{(book.cover_url||book.cover_path)?<img src={(book.owned&&book.cover_path)?`/api/discovery/covers/${book.id}`:(book.cover_url||`/api/discovery/covers/${book.id}`)} alt="" style={{width:"100%",maxHeight:300,objectFit:"contain",borderRadius:8,background:t.bg4}}/>:null}
